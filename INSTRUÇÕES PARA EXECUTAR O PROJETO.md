...
Configuração de IP: No arquivo src/main/resources/application.properties, altere app.api-host para o seu IP local se for testar em um celular.

Swagger UI: Acesse http://localhost:8080/swagger-ui.html para documentação interativa
...
Integração com CPF (Tarefa Bônus 1)
===================================
Implementacao da CpfValidadorrCliente que simula um serviço externo:
